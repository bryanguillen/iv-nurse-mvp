...
export type GetBookingsQueryVariables = Types.Exact<{
 ...
 * });
 */
export function useGetBookingsQuery(baseOptions: Apollo.QueryHookOptions<GetBookingsQuery, GetBookingsQueryVariables> & ({ variables: GetBookingsQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
export function useGetBookingsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetBookingsQuery, GetBookingsQueryVariables>) {
