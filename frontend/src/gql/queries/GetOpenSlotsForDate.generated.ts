...
export type GetOpenSlotsForDateQueryVariables = Types.Exact<{
  nurseId: Types.Scalars['String']['input'];
  serviceId: Types.Scalars['String']['input'];
  start: Types.Scalars['String']['input'];
}>;


export type GetOpenSlotsForDateQuery = { __typename?: 'Query', getAvailableSlots: Array<{ __typename?: 'AvailableSlotsDto', nurseId: string, serviceId: string, startTime: any, endTime: any }> };


export const GetOpenSlotsForDateDocument = gql`
    query GetOpenSlotsForDate($nurseId: String!, $serviceId: String!, $start: String!) {
  getAvailableSlots(
    input: {nurseId: $nurseId, serviceId: $serviceId, start: $start}
  ) {
    nurseId
    serviceId
    startTime
...
/**
 * __useGetOpenSlotsForDateQuery__
 *
 * To run a query within a React component, call `useGetOpenSlotsForDateQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetOpenSlotsForDateQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetOpenSlotsForDateQuery({
 *   variables: {
 ...
 * });
 */
export function useGetOpenSlotsForDateQuery(baseOptions: Apollo.QueryHookOptions<GetOpenSlotsForDateQuery, GetOpenSlotsForDateQueryVariables> & ({ variables: GetOpenSlotsForDateQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetOpenSlotsForDateQuery, GetOpenSlotsForDateQueryVariables>(GetOpenSlotsForDateDocument, options);
      }
export function useGetOpenSlotsForDateLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetOpenSlotsForDateQuery, GetOpenSlotsForDateQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetOpenSlotsForDateQuery, GetOpenSlotsForDateQueryVariables>(GetOpenSlotsForDateDocument, options);
        }
export function useGetOpenSlotsForDateSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetOpenSlotsForDateQuery, GetOpenSlotsForDateQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetOpenSlotsForDateQuery, GetOpenSlotsForDateQueryVariables>(GetOpenSlotsForDateDocument, options);
        }
export type GetOpenSlotsForDateQueryHookResult = ReturnType<typeof useGetOpenSlotsForDateQuery>;
export type GetOpenSlotsForDateLazyQueryHookResult = ReturnType<typeof useGetOpenSlotsForDateLazyQuery>;
export type GetOpenSlotsForDateSuspenseQueryHookResult = ReturnType<typeof useGetOpenSlotsForDateSuspenseQuery>;
export type GetOpenSlotsForDateQueryResult = Apollo.QueryResult<GetOpenSlotsForDateQuery, GetOpenSlotsForDateQueryVariables>;