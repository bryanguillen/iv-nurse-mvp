...
export type SaveOrganizationRecordMutationVariables = Types.Exact<{
  orgId: Types.Scalars['String']['input'];
}>;


export type SaveOrganizationRecordMutation = { __typename?: 'Mutation', createOrganizationRecord: { __typename?: 'OrganizationUuid', id: string } };


export const SaveOrganizationRecordDocument = gql`
    mutation SaveOrganizationRecord($orgId: String!) {
  createOrganizationRecord(input: {supabaseOrgId: $orgId}) {
    id
  }
}
    `;
export type SaveOrganizationRecordMutationFn = Apollo.MutationFunction<SaveOrganizationRecordMutation, SaveOrganizationRecordMutationVariables>;

/**
 * __useSaveOrganizationRecordMutation__
 *
 * To run a mutation, you first call `useSaveOrganizationRecordMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useSaveOrganizationRecordMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [saveOrganizationRecordMutation, { data, loading, error }] = useSaveOrganizationRecordMutation({
 *   variables: {
 *      orgId: // value for 'orgId'
 *   },
 * });
 */
export function useSaveOrganizationRecordMutation(baseOptions?: Apollo.MutationHookOptions<SaveOrganizationRecordMutation, SaveOrganizationRecordMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<SaveOrganizationRecordMutation, SaveOrganizationRecordMutationVariables>(SaveOrganizationRecordDocument, options);
      }
export type SaveOrganizationRecordMutationHookResult = ReturnType<typeof useSaveOrganizationRecordMutation>;
export type SaveOrganizationRecordMutationResult = Apollo.MutationResult<SaveOrganizationRecordMutation>;
export type SaveOrganizationRecordMutationOptions = Apollo.BaseMutationOptions<SaveOrganizationRecordMutation, SaveOrganizationRecordMutationVariables>;