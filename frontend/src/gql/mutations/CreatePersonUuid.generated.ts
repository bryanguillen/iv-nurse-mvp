...
export type CreatePersonUuidMutationVariables = Types.Exact<{
  supabaseId: Types.Scalars['String']['input'];
}>;


export type CreatePersonUuidMutation = { __typename?: 'Mutation', createPersonUuid: { __typename?: 'PersonUuidDto', id: string } };


export const CreatePersonUuidDocument = gql`
    mutation CreatePersonUuid($supabaseId: String!) {
  createPersonUuid(input: {supabaseId: $supabaseId}) {
    id
  }
}
    `;
export type CreatePersonUuidMutationFn = Apollo.MutationFunction<CreatePersonUuidMutation, CreatePersonUuidMutationVariables>;

/**
 * __useCreatePersonUuidMutation__
 *
 * To run a mutation, you first call `useCreatePersonUuidMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreatePersonUuidMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [createPersonUuidMutation, { data, loading, error }] = useCreatePersonUuidMutation({
 *   variables: {
 *      supabaseId: // value for 'supabaseId'
 *   },
 * });
 */
export function useCreatePersonUuidMutation(baseOptions?: Apollo.MutationHookOptions<CreatePersonUuidMutation, CreatePersonUuidMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreatePersonUuidMutation, CreatePersonUuidMutationVariables>(CreatePersonUuidDocument, options);
      }
export type CreatePersonUuidMutationHookResult = ReturnType<typeof useCreatePersonUuidMutation>;
export type CreatePersonUuidMutationResult = Apollo.MutationResult<CreatePersonUuidMutation>;
export type CreatePersonUuidMutationOptions = Apollo.BaseMutationOptions<CreatePersonUuidMutation, CreatePersonUuidMutationVariables>;