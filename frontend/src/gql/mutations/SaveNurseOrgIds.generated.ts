...
export type SaveSupabaseIdsMutation = {
  __typename?: 'Mutation';
  createNurseUuid: { __typename?: 'NurseUuid'; id: string; supabaseId: string };
  createOrganizationRecord: { __typename?: 'OrganizationUuid'; id: string; supabaseOrgId: string };
};
...
`;
export type SaveSupabaseIdsMutationFn = Apollo.MutationFunction<
  SaveSupabaseIdsMutation,
  SaveSupabaseIdsMutationVariables
>;
 ...
 * });
 */
export function useSaveSupabaseIdsMutation(
  ...
  return Apollo.useMutation<SaveSupabaseIdsMutation, SaveSupabaseIdsMutationVariables>(
    SaveSupabaseIdsDocument,
    options
  );
}
...
export type SaveSupabaseIdsMutationOptions = Apollo.BaseMutationOptions<
  SaveSupabaseIdsMutation,
  SaveSupabaseIdsMutationVariables
>;
